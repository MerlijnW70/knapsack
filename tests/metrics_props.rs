...
fn metrics_accounting_filtering_and_resilience() {
    ...
    for _ in 0..2 {
        metrics::record_expand("s1", "ks2_test", 10, true, metrics::ExpandMode::Whole, metrics::ExpandCaller::Cli);
    }
    metrics::record_expand("s1", "ks2_test", 0, false, metrics::ExpandMode::Whole, metrics::ExpandCaller::Cli);
    // s2: 1 compress.
    ...
    metrics::record_expand("s3", "ks2_test", 100, true, metrics::ExpandMode::Whole, metrics::ExpandCaller::Cli);
